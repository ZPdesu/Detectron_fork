...
DATASETS = {
    ...
    'gsv_fac_train': {
        IM_DIR:
            _DATA_DIR + '/gsv/gsv_images',
        ANN_FN:
            _DATA_DIR + '/gsv/annotations/train-fac_zhu.json'
    },
    'gsv_fac_val': {
        IM_DIR:
            _DATA_DIR + '/gsv/gsv_images',
        ANN_FN:
            _DATA_DIR + '/gsv/annotations/val-fac_zhu.json'
    ...
    'gsv_fac_win_train': {
        IM_DIR:
            _DATA_DIR + '/gsv/gsv_images',
        ANN_FN:
            _DATA_DIR + '/gsv/annotations/train-fac-win_zhu.json'
    },
    'gsv_fac_win_val': {
        IM_DIR:
            _DATA_DIR + '/gsv/gsv_images',
        ANN_FN:
            _DATA_DIR + '/gsv/annotations/val-fac-win_zhu.json'
    ...
    'gsv_fac_win_unk_train': {
        IM_DIR:
            _DATA_DIR + '/gsv/gsv_images',
        ANN_FN:
            _DATA_DIR + '/gsv/annotations/train-fac-win-unk_zhu.json'
    },
    'gsv_fac_win_unk_val': {
        IM_DIR:
            _DATA_DIR + '/gsv/gsv_images',
        ANN_FN:
            _DATA_DIR + '/gsv/annotations/val-fac-win-unk_zhu.json'

    },
    'gsv_fac_win_unk_test': {
        IM_DIR:
            _DATA_DIR + '/gsv/gsv_images',
        ANN_FN:
            _DATA_DIR + '/gsv/annotations/val-fac-win-unk_zhu.json'
