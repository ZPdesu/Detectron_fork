...
def main():
    ...
    args.dataset = "gsv_fac"
    args.cfg_file = 'configs/baselines/e2e_faster_rcnn_R-101-FPN_1x.yaml'
    ...
    elif args.dataset == "gsv_fac":
        cfg.TRAIN.DATASETS = ('gsv_fac_train',)
        cfg.MODEL.NUM_CLASSES = 2
    elif args.dataset == "gsv_fac_win":
        cfg.TRAIN.DATASETS = ('gsv_fac_win_train',)
